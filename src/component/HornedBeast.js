  ...
  render(){
    return(
      <div className='card flex align-items-center m-2' style ={{width:'20rem', height: '30rem'}}>
        ...
        <img style ={{maxWidth:'100%', height:'300px', cursor: 'pointer'}} onClick={this.createModal} src={this.props.imageUrl} alt=""/>
        <p className='card-text text-center p-2'>{this.props.description}</p>
        <img onClick={this.addFavorite} style={{width: '20px',height: '20px', cursor: 'pointer'}} src={heart} alt=''/>
